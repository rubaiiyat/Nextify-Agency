...
const CompanyLogos = () => {
  return (
    <div className="bg-gray-800 mb-20 overflow-hidden pb-10">
      <div className="max-w-screen-xl container mx-auto mt-10">
        ...
        <div className="text-center py-5 px-4">
          ...
          <p className="text-gray-400 mb-10 max-w-xl mx-auto">
            We've partnered with some of the most innovative and leading
            companies to bring the best solutions to you.
          </p>
